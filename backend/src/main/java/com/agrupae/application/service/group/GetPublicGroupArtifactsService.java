...
public class GetPublicGroupArtifactsService implements GetPublicGroupArtifactsUseCase {
    ...
    public List<GroupArtifactView> handle(
        ...
        return this.groupArtifactRepository.findPublicByGroupId(groupId).stream()
